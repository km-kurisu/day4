  ...
  return (
    <div className="bg-animated-gradient min-h-screen">
      <Head>
        ...
        <meta name="description" content="Kamlesh Mistry - Portfolio, Education, Goals, Achievements" />
        <meta name="author" content="Kamlesh Mistry" />
        <meta property="og:title" content="km-kurisu.github.io" />
        <meta property="og:description" content="Personal introduction portfolio site." />
      ...
      <main className="px-4 md:px-10 lg:px-40">
        <section className="min-h-screen">
          {/* Stationary Navbar */}
          <nav className="py-6 md:py-10 mb-8 flex justify-between items-center sticky top-0 z-50 w-full left-0 right-0 px-4 md:px-0 bg-transparent rounded-none backdrop-blur-md">
            <h1 className="text-2xl md:text-4xl text-[#52154E] font-stardom dark:text-slate-300">Kamlesh Mistry</h1>
            {/* Desktop Menu */}
            <ul className="hidden md:flex items-center space-x-4 md:space-x-8">
              <li>
                <button
                  onClick={() => setDarkMode(!darkMode)}
                  className="cursor-pointer text-3xl text-gray-600 dark:text-slate-300 bg-transparent border-none"
              ...
              <li>
                <a
                  href="#about"
                  className="hover:underline font-stardom text-lg"
            ...
            {/* Hamburger Icon */}
            <button
              className="md:hidden text-3xl text-[#52154E] dark:text-slate-300"
            ...
            {menuOpen && (
              <div className="mobile-menu-overlay open">
                <button
                  className="absolute top-6 right-6 text-3xl text-[#52154E] dark:text-slate-300"
                  onClick={() => setMenuOpen(false)}
                  aria-label="Close menu"
                >
                  <MdClose />
                </button>
                <a onClick={() => handleNavClick("about")} className="mobile-menu-link">About</a>
                <a onClick={() => handleNavClick("skills")} className="mobile-menu-link">Skills</a>
                <a onClick={() => handleNavClick("achievements")} className="mobile-menu-link">Achievements</a>
                <a onClick={() => handleNavClick("goals")} className="mobile-menu-link">Goals</a>
                <a onClick={() => handleNavClick("personal")} className="mobile-menu-link">Personal</a>
                <a
                  href="/KamleshMistry.pdf"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mobile-menu-link bg-gradient-to-r from-[#0E6BA8] to-[#BCB6FF] text-white px-4 py-2 rounded-sm dark:text-gray-700"
                  onClick={() => setMenuOpen(false)}
                >
                  Resume
                </a>
          ...
          <div id="about" className="text-center p-10 ">
            ...
            <p className="text-md py-5 font-stardom leading-8 text-[#63458A] md:text-xl max-w-xl mx-auto dark:text-slate-300">
            Based in Virar, Maharashtra, India.</p>
            <p className="text-md py-5 leading-8 font-stardom text-[#63458A] md:text-xl max-w-xl mx-auto dark:text-slate-300">
        ...
        <section>
          <div>
            ...
            <p className="text-md font-stardom py-2 leading-8 text-[#001C55] dark:text-slate-300" >
          ...
          <div className="lg:flex lg:gap-10 flex-col lg:flex-row">
            <div id="achievements" className="text-left shadow-xl p-6 md:p-10 rounded-xl my-6 w-full lg:my-10 lg:flex-1 bg-animated-card dark:shadow-2xl">
              ...
              <h4 className="py-4 font-stardom text-teal-600 dark:text-emerald-400">Participation in TechSurf Hackathon in 2023 </h4>
              <p className="text-gray-800 font-stardom py-1 dark:text-emerald-400">Participated in HackON with Amazon S-3</p>
              <p className="text-gray-800 font-stardom py-1 dark:text-emerald-400">Pursuing CS50X Online Course by Harvard</p>
            ...
            <div id="goals" className="text-left shadow-xl p-6 md:p-10 rounded-xl my-6 w-full lg:my-10 lg:flex-1 bg-animated-card dark:shadow-2xl">
              ...
              <h4 className="py-4 font-stardom text-teal-600 dark:text-emerald-400">Complete my B.Tech with specializtion in AI</h4>
              <p className="text-gray-800 font-stardom py-1 dark:text-emerald-400">Create at least 4 games before the end of 3rd Year</p>
              <p className="text-gray-800 font-stardom py-1 dark:text-emerald-400">Land an InternShip</p>
            ...
            <div id="personal" className="text-left shadow-xl p-6 md:p-10 rounded-xl my-6 w-full lg:my-10 lg:flex-1 bg-animated-card dark:shadow-2xl">
              ...
              <h4 className="py-4 text-teal-400 font-stardom dark:text-emerald-400">A Reader, Writer, Observer</h4>
              <p className="text-gray-800 font-stardom py-1 dark:text-emerald-400">Wrote and Proofread many webnovels for various scanalations</p>
              <p className="text-gray-800 font-stardom py-1 dark:text-emerald-400">A hobbyist Digital Illustrator and learning 3D art</p>
              <p className="text-gray-800 font-stardom py-1 dark:text-emerald-400">Love to observe and find the hidden meaning behind the nature's motives</p>
              <p className="text-gray-800 font-stardom py-1 dark:text-emerald-400">A avid watcher of skies</p>
            </div>
          </div>
        </section>
        ...
        <section className="flex flex-col items-center justify-center my-12">
          <div className="bg-animated-gradient rounded-xl shadow-lg p-6 max-w-xl w-full text-center">
            <h3 className="text-3xl font-arrayr text-[#52154E] dark:text-[#BCB6FF] mb-4">Random Joke</h3>
            {loadingJoke ? (
              <p className="text-[#001C55] dark:text-teal-300">Loading...</p>
            ) : joke ? (
              <div className="text-lg font-stardom text-[#52154E] dark:text-[#BCB6FF] min-h-[60px]">
                {joke.type === "single" ? (
                  <span>{joke.joke}</span>
                ) : (
                  <>
          ...
          <footer className="text-[#63458A] text-center py-4 font-nippo dark:text-emerald-400">
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 mt-2 text-base">
              <span className="flex items-center gap-2">
                <svg className="inline-block w-5 h-5 font-stardom text-teal-500" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M16 12a4 4 0 01-8 0V8a4 4 0 018 0v4z"/><path d="M12 16v2m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
              ...
              <div  className="flex flex-col font-stardom md:flex-row items-center justify-center gap-4 mt-2 text-base">
